...
<div class="wp-block-group has-background-color has-foreground-background-color has-text-color has-background has-link-color">
	...
	<div class="wp-block-columns alignwide" style="padding-top:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large)">
		...
		<div class="wp-block-column">
			...
			<!-- wp:search {"ariaLabel":"<?php esc_attr_e( 'Footer', 'greyd-wp' ); ?>","label":"<?php esc_html_e( 'Search', 'greyd-wp' ); ?>","showLabel":false,"buttonText":"<?php esc_html_e( 'Search', 'greyd-wp' ); ?>","buttonUseIcon":true,"className":""} /-->
		</div>
		<!-- /wp:column -->
	</div>
	<!-- /wp:columns -->

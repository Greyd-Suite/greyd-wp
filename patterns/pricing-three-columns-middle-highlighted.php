 ...
 * Slug: greyd-theme/pricing-three-columns-middle-highlighted
 * Description:
...
<div class="wp-block-columns alignwide are-vertically-aligned-bottom">
	...
	<div class="wp-block-column is-vertically-aligned-bottom">
		...
		<div class="wp-block-group has-foreground-color has-lightest-background-color has-text-color has-background has-link-color" style="border-radius:4px">
			...
			<div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--foreground);border-bottom-style:dotted;border-bottom-width:1px;padding-bottom:var(--wp--preset--spacing--medium)">
				...
				<h3 class="wp-block-heading has-medium-font-size"><?php esc_html_e( 'Monthly', 'greyd-theme' ); ?></h3>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group">
				...
				<p class="has-normal-font-size" style="line-height:1.5"><?php esc_html_e( 'Gives you the most freedom. Perfect if you want to try us out', 'greyd-theme' ); ?></p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph {"className":"","fontSize":"x-large"} -->
				<p class="has-x-large-font-size">
					<strong><?php esc_html_e( '$5,99', 'greyd-theme' ); ?></strong> <sub><?php esc_html_e( '/mo.', 'greyd-theme' ); ?></sub>
				</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		...
		<div class="wp-block-group has-background-color has-foreground-background-color has-text-color has-background has-link-color" style="border-radius:8px;padding-top:2px;padding-right:2px;padding-bottom:2px;padding-left:2px">
			...
			<div class="wp-block-group has-foreground-color has-lightest-background-color has-text-color has-background has-link-color" style="border-top-left-radius:0px;border-top-right-radius:0px;border-bottom-left-radius:4px;border-bottom-right-radius:4px">
				...
				<div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--foreground);border-bottom-style:dotted;border-bottom-width:1px;padding-bottom:var(--wp--preset--spacing--medium)">
					...
					<h3 class="wp-block-heading has-large-font-size"><strong><?php esc_html_e( 'Quarterly', 'greyd-theme' ); ?></strong></h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
				...
				<div class="wp-block-group">
					<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}},"className":"","fontSize":"normal"} -->
					<p class="has-normal-font-size" style="line-height:1.5"><?php esc_html_e( 'For companies of all sizes, who know what they need.', 'greyd-theme' ); ?></p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph {"className":"","fontSize":"x-large"} -->
					<p class="has-x-large-font-size">
						<strong><?php esc_html_e( '$5,49', 'greyd-theme' ); ?></strong> <sub><?php esc_html_e( '/mo.', 'greyd-theme' ); ?></sub>
					</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
	...
	<div class="wp-block-column is-vertically-aligned-bottom">
		...
		<div class="wp-block-group has-foreground-color has-lightest-background-color has-text-color has-background has-link-color" style="border-radius:4px">
			...
			<div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--foreground);border-bottom-style:dotted;border-bottom-width:1px;padding-bottom:var(--wp--preset--spacing--medium)">
				<!-- wp:heading {"level":3,"className":"","fontSize":"medium"} -->
				<h3 class="wp-block-heading has-medium-font-size"><?php esc_html_e( 'Yearly', 'greyd-theme' ); ?></h3>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group">
				<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}},"className":"","fontSize":"normal"} -->
				<p class="has-normal-font-size" style="line-height:1.5"><?php esc_html_e( 'The most cost-effective option. For a long-term relationship.', 'greyd-theme' ); ?></p>
				<!-- /wp:paragraph -->

 ...
 * Slug: greyd-wp/general-404-simple
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--x-large)">
	...
	<h1 class="wp-block-heading"><?php esc_html_e( 'Error 404', 'greyd-wp' ); ?></h1>
	<!-- /wp:heading -->
	...
	<div class="wp-block-buttons">
		...
		<div class="wp-block-button is-style-outline">
			<a class="wp-block-button__link wp-element-button" href="javascript:history.back()"><?php esc_html_e( 'Go back', 'greyd-wp' ); ?></a>
		</div>
		<!-- /wp:button -->

		<!-- wp:button {"className":"is-style-prim"} -->
		<div class="wp-block-button is-style-prim">
			<a class="wp-block-button__link wp-element-button" href="/"><?php esc_html_e( 'Go to home page', 'greyd-wp' ); ?></a>
		</div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->

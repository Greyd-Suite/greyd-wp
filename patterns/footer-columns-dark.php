<?php
/**
 * Title: Footer with Four Columns, Dark
 * Slug: greyd-wp/footer-columns-dark
 ...
 */
?>
<!-- wp:group {"style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}}},"backgroundColor":"foreground","textColor":"background","className":"","layout":{"inherit":true,"type":"constrained"}} -->
	...
	<div class="wp-block-columns alignwide" style="padding-top:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large)">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group">
					<!-- wp:heading {"level":3,"fontSize":"small"} -->
					<h3 class="wp-block-heading has-small-font-size"><?php esc_html_e( 'Socials', 'greyd-wp' ); ?></h3>
					<!-- /wp:heading -->

					<!-- wp:social-links {"iconColor":"background","iconColorValue":"#f9f7ff","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|small"}}},"className":"is-style-logos-only"} -->

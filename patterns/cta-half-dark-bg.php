 ...
 * Slug: greyd-wp/cta-half-dark-bg
 * Description:
		...
		<div class="wp-block-column is-vertically-aligned-top">
			...
			<div class="wp-block-group">
				...
				<h2 class="wp-block-heading has-background-color has-text-color" style="margin-top:0;margin-bottom:0">
					<?php esc_html_e( 'All WordPress.', 'greyd-wp' ); ?><br>
					<mark class="has-inline-color has-secondary-color"><?php esc_html_e( 'One Suite.', 'greyd-wp' ); ?></mark>
				</h2>
				<!-- /wp:heading -->

				<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}}},"textColor":"background","className":""} -->
				<p class="has-background-color has-text-color has-link-color"><?php esc_html_e( 'Whether you are a freelancer, agency or large corporation, your WordPress revolution starts here.', 'greyd-wp' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->

 ...
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large"}},"color":{"gradient":"linear-gradient(180deg,rgb(0,0,0,0) 30%,var(--wp--preset--color--primary) 30%,var(--wp--preset--color--primary) 70%,rgb(0,0,0,0) 70%)"}},"layout":{"type":"default"}} -->
<div class="wp-block-group alignfull has-background" style="background:linear-gradient(180deg,rgb(0,0,0,0) 30%,var(--wp--preset--color--primary) 30%,var(--wp--preset--color--primary) 70%,rgb(0,0,0,0) 70%);padding-top:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--x-large)">
	...
	<div class="wp-block-columns" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
		...
		<!-- wp:column {"verticalAlignment":"bottom","style":{"spacing":{"padding":{"top":"0","bottom":"0"},"blockGap":"0"}}} -->
		<div class="wp-block-column is-vertically-aligned-bottom" style="padding-top:0;padding-bottom:0">
			<!-- wp:image {"aspectRatio":"1","scale":"cover","sizeSlug":"thumbnail","style":{"color":{"duotone":"var:preset|duotone|primary-background"}},"className":"is-style-default"} -->
			<figure class="wp-block-image size-thumbnail is-style-default">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/white-and-black-cubes-and-pyramids.webp" alt="" style="aspect-ratio:1;object-fit:cover" />
			</figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
	...
	<div class="wp-block-columns" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
		...
		<!-- wp:column {"verticalAlignment":"top"} -->
		<div class="wp-block-column is-vertically-aligned-top">
			<!-- wp:image {"aspectRatio":"1","scale":"cover","sizeSlug":"thumbnail","style":{"color":{"duotone":"var:preset|duotone|primary-secondary"}},"className":"is-style-default"} -->
			<figure class="wp-block-image size-thumbnail is-style-default">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/white-cubes-and-spheres-floating.webp" alt="" style="aspect-ratio:1;object-fit:cover" />
			</figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->

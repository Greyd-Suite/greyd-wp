 ...
 * Slug: greyd-theme/content-separator-fixed-background
...
<div class="wp-block-group alignfull has-secondary-background-color has-background" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
	<!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/dark-transparent-background-pattern.webp","hasParallax":true,"isRepeated":true,"dimRatio":50,"isUserOverlayColor":true,"minHeight":20,"minHeightUnit":"em","gradient":"primary-to-secondary","align":"full","style":{"elements":{"link":{"color":{"text":"var:preset|color|foreground"}}},"color":{"duotone":"var:preset|duotone|foreground-background"}},"textColor":"foreground","className":"is-style-no-background"} -->
	<div class="wp-block-cover alignfull has-parallax is-repeated is-style-no-background has-foreground-color has-text-color has-link-color" style="min-height:20em">
		...
		<div class="wp-block-cover__image-background has-parallax is-repeated" style="background-position:50% 50%;background-image:url(<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/dark-transparent-background-pattern.webp)"></div>

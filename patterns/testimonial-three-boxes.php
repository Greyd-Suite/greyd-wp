	...
	<div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--large)">
		...
		<div class="wp-block-buttons">
			...
			<div class="wp-block-button is-style-outline is-style-sec">
				<a href="#" class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Read stories', 'greyd-wp' ); ?></a>
			</div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group has-lightest-background-color has-background" style="border-radius:4px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
				...
				<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)">
					<!-- wp:heading {"textAlign":"left","level":3,"className":"","fontSize":"base"} -->
					<h3 class="wp-block-heading has-text-align-left has-base-font-size"><?php esc_html_e( 'Roger', 'greyd-wp' ); ?></h3>
					<!-- /wp:heading -->
					...
					<div class="wp-block-buttons">
						...
						<div class="wp-block-button is-size-small is-style-alternate">
							<a href="#" class="wp-block-button__link wp-element-button"><?php esc_html_e( "Read Roger's story", 'greyd-wp' ); ?></a>
						</div>
						<!-- /wp:button -->
					</div>
					<!-- /wp:buttons -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group has-lightest-background-color has-background" style="border-radius:4px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
				...
				<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)">
					<!-- wp:heading {"textAlign":"left","level":3,"className":"","fontSize":"base"} -->
					<h3 class="wp-block-heading has-text-align-left has-base-font-size"><?php esc_html_e( 'Nils', 'greyd-wp' ); ?></h3>
					<!-- /wp:heading -->
					...
					<div class="wp-block-buttons">
						<!-- wp:button {"className":"is-size-small is-style-alternate"} -->
						<div class="wp-block-button is-size-small is-style-alternate">
							<a href="#" class="wp-block-button__link wp-element-button"><?php esc_html_e( "Read Nils' story", 'greyd-wp' ); ?></a>
						</div>
						<!-- /wp:button -->
					</div>
					<!-- /wp:buttons -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group has-lightest-background-color has-background" style="border-radius:4px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
				...
				<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)">
					<!-- wp:heading {"textAlign":"left","level":3,"className":"","fontSize":"base"} -->
					<h3 class="wp-block-heading has-text-align-left has-base-font-size"><?php esc_html_e( 'Kurt', 'greyd-wp' ); ?></h3>
					<!-- /wp:heading -->
					...
					<div class="wp-block-buttons">
						<!-- wp:button {"className":"is-size-small is-style-alternate"} -->
						<div class="wp-block-button is-size-small is-style-alternate">
							<a href="#" class="wp-block-button__link wp-element-button"><?php esc_html_e( "Read Kurt's story", 'greyd-wp' ); ?></a>
						</div>
						<!-- /wp:button -->
					</div>
					<!-- /wp:buttons -->

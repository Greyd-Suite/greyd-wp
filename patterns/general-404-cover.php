...
<div class="wp-block-group alignwide" style="margin-top:0">
	...
	<div class="wp-block-group alignwide has-primary-background-color has-background" style="border-radius:8px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
		<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/dark-transparent-background-pattern.webp","dimRatio":70,"isUserOverlayColor":true,"minHeight":65,"minHeightUnit":"vh","gradient":"primary-to-foreground","contentPosition":"center center","align":"wide","className":"is-style-no-background","style":{"spacing":{"padding":{"top":"var:preset|spacing|medium","right":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium","left":"var:preset|spacing|medium"},"margin":{"top":"0","bottom":"0"}},"color":{"duotone":"var:preset|duotone|foreground-background"},"border":{"radius":"8px"},"elements":{"link":{"color":{"text":"var:preset|color|lightest"}}}},"textColor":"lightest","layout":{"type":"default"}} -->
		<div class="wp-block-cover alignwide is-style-no-background has-lightest-color has-text-color has-link-color" style="border-radius:8px;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium);min-height:65vh">

<?php
/**
 * Title: Branded Cover Box 3 boxes below
 * Slug: greyd-theme/hero-branded-cover-box-3-boxes-below
 * Description:
...
<div class="wp-block-group">
	<!-- wp:group {"align":"wide","style":{"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|medium"}}},"layout":{"type":"constrained"}} -->
			...
			<div class="wp-block-cover alignwide has-custom-content-position is-position-bottom-left full-rounded-cover full-rounded-image is-style-no-background" style="border-radius:8px;padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large);min-height:600px">
				...
				<div class="wp-block-cover__inner-container">
					...
					<div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--foreground);border-bottom-style:dotted;border-bottom-width:1px;padding-top:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium)">
						...
						<h1 class="wp-block-heading has-text-align-left has-foreground-color has-text-color has-link-color"><?php esc_html_e( 'Greyd Theme', 'greyd-theme' ); ?></h1>
						<!-- /wp:heading -->

						<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|foreground"}}}},"textColor":"foreground","className":""} -->
						<p class="has-foreground-color has-text-color has-link-color"><?php esc_html_e( 'Our free block theme enhances your full site editing experience with powerful extensions. It is the ideal basis for any website you build with Greyd.Suite, but can also be used independently.', 'greyd-theme' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
	...
	<!-- wp:group {"align":"wide","style":{"spacing":{"margin":{"top":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium"}}},"className":"","layout":{"type":"constrained"}} -->
	<div class="wp-block-group alignwide" style="margin-top:var(--wp--preset--spacing--medium);margin-bottom:var(--wp--preset--spacing--medium)">
		...
		<div class="wp-block-columns alignwide" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
			...
			<div class="wp-block-column is-vertically-aligned-stretch" style="flex-basis:33.33%">
				<!-- wp:group {"style":{"border":{"radius":"8px","style":"dotted","width":"1px"},"layout":{"selfStretch":"fit","flexSize":null}},"borderColor":"foreground","backgroundColor":"lightest","className":"","layout":{"type":"flex","orientation":"vertical","justifyContent":"left","verticalAlignment":"space-between"}} -->
				<div class="wp-block-group has-border-color has-foreground-border-color has-lightest-background-color has-background" style="border-style:dotted;border-width:1px;border-radius:8px">
			...
			<div class="wp-block-column is-vertically-aligned-stretch" style="flex-basis:33.33%">
				<!-- wp:group {"style":{"border":{"radius":"8px","style":"dotted","width":"1px"},"layout":{"selfStretch":"fit","flexSize":null}},"borderColor":"foreground","backgroundColor":"lightest","className":"","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch","verticalAlignment":"space-between"}} -->
				<div class="wp-block-group has-border-color has-foreground-border-color has-lightest-background-color has-background" style="border-style:dotted;border-width:1px;border-radius:8px">
			...
			<!-- wp:column {"verticalAlignment":"stretch","width":"33.33%"} -->
			<div class="wp-block-column is-vertically-aligned-stretch" style="flex-basis:33.33%">
				<!-- wp:group {"style":{"border":{"radius":"8px","style":"dotted","width":"1px"},"layout":{"selfStretch":"fit","flexSize":null}},"borderColor":"foreground","backgroundColor":"lightest","className":"","layout":{"type":"flex","orientation":"vertical","verticalAlignment":"space-between","justifyContent":"left"}} -->
				<div class="wp-block-group has-border-color has-foreground-border-color has-lightest-background-color has-background" style="border-style:dotted;border-width:1px;border-radius:8px">
